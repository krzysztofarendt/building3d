...
def test_point_in_b0(bdg):
    ...
    assert find_location(pt, bdg) == "z0/b0"
    assert find_location(pt, bdg, "z0/b0") == "z0/b0"
    assert find_location(pt, bdg, "z0/b1") == "z0/b0"
    assert find_location(pt, bdg, "z1/b2") == "z0/b0"
    assert find_location(pt, bdg, "z1/b3") == "z0/b0"


def test_point_in_b1(bdg):
    pt = new_point(1.5, 0.5, 0.0)  # z at floor
    assert find_location(pt, bdg) == "z0/b1"
    assert find_location(pt, bdg, "z0/b0") == "z0/b1"
    assert find_location(pt, bdg, "z0/b1") == "z0/b1"
    assert find_location(pt, bdg, "z1/b2") == "z0/b1"
    assert find_location(pt, bdg, "z1/b3") == "z0/b1"


def test_point_in_b2(bdg):
    pt = new_point(2.5, 0.5, 1.0)  # z at ceiling
    assert find_location(pt, bdg) == "z1/b2"
    assert find_location(pt, bdg, "z0/b0") == "z1/b2"
    assert find_location(pt, bdg, "z0/b1") == "z1/b2"
    assert find_location(pt, bdg, "z1/b2") == "z1/b2"
    assert find_location(pt, bdg, "z1/b3") == "z1/b2"

def test_point_in_b3(bdg):
    pt = new_point(3.5, 1.0, 1.0)  # corner
    assert find_location(pt, bdg) == "z1/b3"
    assert find_location(pt, bdg, "z1/b3", "z0/b0") == "z1/b3"
    assert find_location(pt, bdg, "z1/b3", "z0/b0") == "z1/b3"
    assert find_location(pt, bdg, "z1/b3", "z0/b0") == "z1/b3"
    assert find_location(pt, bdg, "z1/b3", "z0/b0") == "z1/b3"
